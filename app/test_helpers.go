...
func setup(withGenesis bool, invCheckPeriod uint) (*EveApp, GenesisState) {
	...
	app := NewEveApp(log.NewNopLogger(), db, nil, true, map[int64]bool{}, DefaultNodeHome, invCheckPeriod, encCdc, EmptyAppOptions{})
	if withGenesis {
...
func NewSimappWithCustomOptions(t *testing.T, isCheckTx bool, options SetupOptions) *EveApp {
	...
	app := NewEveApp(options.Logger, options.DB, nil, true, options.SkipUpgradeHeights, options.HomePath, options.InvCheckPeriod, options.EncConfig, options.AppOpts)
...
func AddTestAddrsFromPubKeys(app *EveApp, ctx sdk.Context, pubKeys []cryptotypes.PubKey, accAmt sdk.Int) {
...
func AddTestAddrs(app *EveApp, ctx sdk.Context, accNum int, accAmt sdk.Int) []sdk.AccAddress {
	return addTestAddrs(app, ctx, accNum, accAmt, createRandomAccounts)
}

// AddTestAddrsIncremental constructs and returns accNum amount of accounts with an
// initial balance of accAmt in random order
func AddTestAddrsIncremental(app *EveApp, ctx sdk.Context, accNum int, accAmt sdk.Int) []sdk.AccAddress {
	return addTestAddrs(app, ctx, accNum, accAmt, createIncrementalAccounts)
}

func addTestAddrs(app *EveApp, ctx sdk.Context, accNum int, accAmt sdk.Int, strategy GenerateAccountStrategy) []sdk.AccAddress {
