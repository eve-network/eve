...
func checkValidator(t *testing.T, app *simapp.EveApp, addr sdk.ValAddress, expFound bool) types.Validator {
...
func checkDelegation(
	t *testing.T, app *simapp.EveApp, delegatorAddr sdk.AccAddress,
