...
func createTestInput(t *testing.T) (*codec.LegacyAmino, *simapp.EveApp, sdk.Context) {
...
func generateAddresses(app *simapp.EveApp, ctx sdk.Context, numAddrs int) ([]sdk.AccAddress, []sdk.ValAddress) {
...
func delegateCoinsFromAccount(ctx sdk.Context, app *simapp.EveApp, addr sdk.AccAddress, amount math.Int, val types.Validator) error {
