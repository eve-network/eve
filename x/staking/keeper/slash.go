...
import (
	...
	types "github.com/notional-labs/eve/x/staking/types"
)
...
func (k Keeper) Slash(ctx sdk.Context, consAddr sdk.ConsAddress, infractionHeight int64, power int64, slashFactor sdk.Dec) math.Int {
	...
	k.BeforeValidatorModified(ctx, operatorAddress) //nolint:errcheck
	...
	if validator.Tokens.IsPositive() {
		...
		k.BeforeValidatorSlashed(ctx, operatorAddress, effectiveFraction) //nolint:errcheck
	}
