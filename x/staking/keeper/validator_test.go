...
func bootstrapValidatorTest(t testing.TB, power int64, numAddrs int) (*simapp.EveApp, sdk.Context, []sdk.AccAddress, []sdk.ValAddress) {
...
func initValidators(t testing.TB, power int64, numAddrs int, powers []int64) (*simapp.EveApp, sdk.Context, []sdk.AccAddress, []sdk.ValAddress, []types.Validator) {
...
func TestSlashToZeroPowerRemoved(t *testing.T) {
	...
	app.StakingKeeper.SetValidatorByConsAddr(ctx, validator) //nolint:errcheck
...
func TestValidatorBasics(t *testing.T) {
	...
	app.StakingKeeper.SetValidatorByConsAddr(ctx, validators[0]) //nolint:errcheck
