...
func TestOrganizeAggregate(t *testing.T) {
	...
	sdrBallot := types.ExchangeRateBallot{
		types.NewVoteForTally(sdk.NewDec(17), types.MicroSDRDenom, ValAddrs[0], power),
		types.NewVoteForTally(sdk.NewDec(10), types.MicroSDRDenom, ValAddrs[1], power),
		types.NewVoteForTally(sdk.NewDec(6), types.MicroSDRDenom, ValAddrs[2], power),
	}
	krwBallot := types.ExchangeRateBallot{
		types.NewVoteForTally(sdk.NewDec(1000), types.MicroKRWDenom, ValAddrs[0], power),
		types.NewVoteForTally(sdk.NewDec(1300), types.MicroKRWDenom, ValAddrs[1], power),
		types.NewVoteForTally(sdk.NewDec(2000), types.MicroKRWDenom, ValAddrs[2], power),
	}
