...
func (k Keeper) initializeValidator(ctx sdk.Context, val sdkstaking.ValidatorI) {
...
func (k Keeper) IncrementValidatorPeriod(ctx sdk.Context, val sdkstaking.ValidatorI) uint64 {
