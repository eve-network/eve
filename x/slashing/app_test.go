...
func checkValidator(t *testing.T, app *simapp.EveApp, _ sdk.AccAddress, expFound bool) stakingtypes.Validator {
...
func checkValidatorSigningInfo(t *testing.T, app *simapp.EveApp, addr sdk.ConsAddress, expFound bool) types.ValidatorSigningInfo {
	ctxCheck := app.BaseApp.NewContext(true, tmproto.Header{})
...
func TestSlashingMsgs(t *testing.T) {
	...
	require.Error(t, err)
	require.Nil(t, res)
	require.True(t, errors.Is(sdkslashingtypes.ErrValidatorNotJailed, err))
}
