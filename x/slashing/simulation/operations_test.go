...
import (
	...
	"github.com/notional-labs/eve/x/slashing/simulation"
	"github.com/notional-labs/eve/x/slashing/types"
...
func TestSimulateMsgUnjail(t *testing.T) {
	...
	app.StakingKeeper.SetValidatorByConsAddr(ctx, validator0) // nolint:errcheck
...
func getTestingValidator0(t *testing.T, app *simapp.EveApp, ctx sdk.Context, accounts []simtypes.Account) stakingtypes.Validator {
...
func getTestingValidator(t *testing.T, app *simapp.EveApp, ctx sdk.Context, accounts []simtypes.Account, commission stakingtypes.Commission, n int) stakingtypes.Validator {
	account := accounts[n]
