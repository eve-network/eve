...
import (
	...
	"github.com/eve-network/eve/tests/e2e/configurer/chain"
	"github.com/eve-network/eve/tests/e2e/configurer/config"
	"github.com/eve-network/eve/tests/e2e/containers"
	"github.com/eve-network/eve/tests/e2e/initialization"
)
...
func (uc *UpgradeConfigurer) ConfigureChain(chainConfig *chain.Config) error {
	...
	tmpDir, err := os.MkdirTemp("", "eve-e2e-testnet-")
	if err != nil {
		return err
	}
...
func (uc *UpgradeConfigurer) upgradeContainers(chainConfig *chain.Config, propHeight int64) error {
	...
	uc.containerManager.EveRepository = containers.CurrentBranchRepository
	uc.containerManager.EveTag = containers.CurrentBranchTag
