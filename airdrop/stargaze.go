...
func fetchStargazeTokenPriceWithRetry(apiURL string) (sdkmath.LegacyDec, error) {
	...
	return sdkmath.LegacyDec{}, fmt.Errorf("failed to fetch Stargaze token price after %d attempts: %v", MaxRetries, err)
}
