...
If you wish to append this balance to an already existing account, you must use the "--append" flag.
This will increase the total tokens a user owns and update the supply accordingly.
`,
