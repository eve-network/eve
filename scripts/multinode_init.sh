...
update_test_genesis () {
    ...
    # SingleInstance: cat $HOME/.eved/config/genesis.json | jq "$1" > $HOME/.eved/config/tmp_genesis.json && mv $HOME/.eved/config/tmp_genesis.json $HOME/.eved/config/genesis.json
    cat $CHAIN_DIR/$CHAINID_1/config/genesis.json | jq "$1" > $CHAIN_DIR/$CHAINID_1/config/tmp_genesis.json && mv $CHAIN_DIR/$CHAINID_1/config/tmp_genesis.json $CHAIN_DIR/$CHAINID_1/config/genesis.json
    cat $CHAIN_DIR/$CHAINID_2/config/genesis.json | jq "$1" > $CHAIN_DIR/$CHAINID_2/config/tmp_genesis.json && mv $CHAIN_DIR/$CHAINID_2/config/tmp_genesis.json $CHAIN_DIR/$CHAINID_2/config/genesis.json
}
...
sed -i 's/cors_allowed_origins = \[\]/cors_allowed_origins = \["\*"\]/g' $CHAIN_DIR/$CHAINID_1/config/app.toml
...
sed -i 's/cors_allowed_origins = \[\]/cors_allowed_origins = \["\*"\]/g' $CHAIN_DIR/$CHAINID_2/config/app.toml
